...
class AuthAdminSettings(AdminSettings):
    ...
    admin_user_app_title: str = Field(default="Hallo, {{session.user.name}}!", title="Admin User App Title", description="The title of the admin panel for the user. "
    ...
    admin_superuser_name: Optional[str] = Field(default="admin", title="Admin User Superuser username", description="The username of the superuser of the admin panel.")
